...
public class JingleOfferFactory
{
	...
	//START NEW CODE
	int maxBitRate = 5000000;
	addParameterExtension(vp8, "x-google-max-bitrate", String.valueOf(maxBitRate));
	addParameterExtension(h264, "x-google-max-bitrate", String.valueOf(maxBitRate));
	addParameterExtension(vp9, "x-google-max-bitrate", String.valueOf(maxBitRate));
	//END NEW CODE
