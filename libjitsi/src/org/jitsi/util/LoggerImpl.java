    ...
    extends Logger
{
    ...
    public void log(Level level, Object msg)
    {
        ...
        loggerDelegate.log(level, msg != null ? (System.currentTimeMillis() + " " + msg.toString()) : "null");
    }
    ...
    {
        loggerDelegate.log(level, msg != null ? (System.currentTimeMillis() + " " + msg.toString()) : "null", thrown);
    }
