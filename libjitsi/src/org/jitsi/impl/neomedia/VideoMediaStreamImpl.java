    ...
    implements VideoMediaStream
{
    ...
    private SenderBitrateController senderBitrateController;
    /**
    ...
    public VideoMediaStreamImpl(StreamConnector connector, MediaDevice device,
        SrtpControl srtpControl, SenderBitrateController senderBitrateControl)
    {
        super(connector, device, srtpControl);
	
	senderBitrateController = senderBitrateControl;
