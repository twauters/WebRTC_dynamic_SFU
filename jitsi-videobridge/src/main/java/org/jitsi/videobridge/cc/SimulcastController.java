    ...
    implements AutoCloseable
{
	...
	String log = "currentIndex:"+currentIndex + " targetIndex:" + targetIndex + "\n";
	for (RTPEncodingDesc rtpEncoding : sourceEncodings)
        {
		log+=rtpEncoding.toString()+"\n";
	}
	logger.debug(log);
    ...
    class BitstreamController
    {
		...
		// if (logger.isDebugEnabled())
  //           	{
  //               logger.debug("available qualities: rtpEncodings.length: " + rtpEncodings.length + " - availableQualities.length: " + availableQualities.size());
  //           	}		
