     ...
     implements PropertyChangeListener
{
	...
	this.senderController = new SenderController(this);
	...
	logger.warn("getting SenderController");
    ...
    private void sctpConnectionReady(SctpConnection sctpConnection)
    {
                ...
                && sctpConnection.isReady())
        {
			...
			first=false;
			speechActivity.activeSpeakerChanged(endpoint.getChannels(MediaType.VIDEO).get(0).getReceiveSSRCs()[0] & 0xFFFFFFFFL);
		}
